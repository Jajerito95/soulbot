...
try:
    ...
    raise RuntimeError(f"PORT inválido: {os.getenv('PORT')!r}")
...
# Contraseña de confirmación para /levels resetserver (DEBE definirse en producción vía variable de entorno)
